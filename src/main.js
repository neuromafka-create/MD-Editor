...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const ctxItems = [
    ...
    { divider: true },
    { icon: '•', label: 'Маркированный список', action: () => applyLinePrefix(markdownInput, previewOutput, '- ') },
    { icon: '1.', label: 'Нумерованный список', action: () => applyOrderedList(markdownInput, previewOutput) },
    { icon: '☑', label: 'Список задач', action: () => applyTaskList(markdownInput, previewOutput) },
    { divider: true },
